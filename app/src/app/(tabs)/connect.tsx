  ...
  return (
    <Screen
      ...
      {isConnected && state.device && (
        <Card>
          {/* Lo técnico (dirección, firmware, telemetría de la placa) ya no se muestra: va a los logs
              de Supabase (services/telemetria). El usuario ve lo que le sirve: estado, batería y red. */}
