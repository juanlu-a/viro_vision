...
export const es = {
  ...
  reader: {
    ...
    modeSuperOnHint:
      'Equivale a dos clicks del botón del dispositivo. Identifica un producto con un modelo de visión.',
    ...
    readButton: 'Elegir foto y leer',
    readHintEsperando: 'Primero activá un modo.',
    readHintBus: 'Abre la fototeca, lee el cartel de la foto con el OCR local y anuncia la línea en voz alta.',
    readHintSuper: 'Abre la fototeca, identifica el producto de la foto y lo anuncia en voz alta.',
    preparing: 'Preparando el lector… la primera vez descarga unos 250 MB.',
    preparingBig: 'Preparando el modelo local… la primera vez descarga unos 3 GB.',
    reading: 'Leyendo…',
    line: 'Línea',
    ...
    fellBackToLocal: 'Sin respuesta de la nube; se usó el modelo local.',
  ...
  ondevice: {
    ...
    ocrSection: 'OCR local',
    ocrIntro:
      'Detecta y lee el texto de una foto con modelos entrenados, sin un modelo de lenguaje. Unos 250 MB contra los 3 GB de un modelo multimodal.',
    ocrPrepare: 'Preparar OCR (español)',
    ocrPrepareHint: 'Descarga el detector y el reconocedor la primera vez, y los carga en memoria.',
    ocrLoading: 'Preparando el OCR…',
    ocrReady: 'OCR listo.',
    ocrError: 'Falló el OCR',
    ocrRead: 'Leer una foto con OCR',
    ocrReadHint: 'Elige una foto y devuelve los textos detectados con su posición y confianza.',
    ocrLoadTime: 'Tiempo de carga del OCR',
