...
export const es = {
  ...
  reader: {
    section: 'Leer un cartel',
    intro: 'Elegí una foto de un ómnibus y la app te dice la línea en voz alta.',
    pathLabel: 'Camino',
    pathHint: 'Alterna cómo se lee: OCR local (rápido, sin internet), modelo local (más lento, entiende más), o nube (necesita internet).',
    pathOcr: 'OCR local',
    pathVlm: 'Modelo local',
    pathCloud: 'Nube',
    readButton: 'Elegir foto y leer',
    readHint: 'Abre la fototeca, lee el cartel con el camino elegido y anuncia el resultado en voz alta.',
    preparing: 'Preparando el lector… la primera vez descarga unos 250 MB.',
    preparingBig: 'Preparando el modelo… la primera vez descarga unos 3 GB.',
    reading: 'Leyendo…',
    line: 'Línea',
